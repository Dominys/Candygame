package sm.game
{
    ...
    public class base_overlay_autoclose_3_5 extends base_clip
    {

        public function base_overlay_autoclose_3_5()
        {
            if (globals.dictionary)
            {
                globals.dictionary.addEventListener("countdown", countdown, false, 0, true);
            }
            TweenMax.to(this, 0.5, {alpha:0, delay:3.5, ease:Linear.easeNone, onComplete:closeMe});
            return;
        }// end function
